...
def default_argument_parser():
    ...
    parser.add_argument(
        "--port", type=int, default=10022
    )
    parser.add_argument('--wandb', action='store_true')
    parser.add_argument('--entity', default='mango_smoothie')
    parser.add_argument('--project', default='[YOUR wandb project]')
    parser.add_argument('--id', default=time_fmt)
    parser.add_argument('--exp-name', default='[YOUR experiment name]')
